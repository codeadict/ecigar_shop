# Django settings for ecigar_shop project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cigars.db', # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.join(PROJECT_PATH, "static_server")
...
SECRET_KEY = 'i@y0*^e*^vdb7zm+d&k6wh^mh5zqvrxs%)#4oxa^7q6hvuwsg8'
...
ROOT_URLCONF = 'ecigar_shop.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ecigar_shop.wsgi.application'
...
CMS_TEMPLATES = (
   ...
   # ('internal.html', 'Internal Content Template'),
)
...
#Payment stuff
PAYPAL_RECEIVER_EMAIL = 'dairon.medina@gmail.com'
